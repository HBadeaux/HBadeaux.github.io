(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 0, 0);
        collectable.create(type.steve, 400, 200, 0, 0);
        collectable.create(type.steve, 400, 500, 0, 0);
        collectable.create(type.steve, 500, 60, 0, 0);
